...
class ConversationRepository(BaseRepository[Conversation]):
    ...
    def get_by_user_and_id(
        ...
        *,
        ...
        """Retrieve a conversation by user and conversation ID."""
    ...
    def list_by_user_and_knowledge_base(
        ...
        *,
        ...
        """Return conversations for a user's knowledge base ordered newest first."""
        statement = (
            select(Conversation)
            .where(
    ...
    def list_page_by_user_and_knowledge_base(
        self,
        *,
        user_id: UUID,
        knowledge_base_id: UUID,
        ...
        """Return a stable keyset page for a user's knowledge base ordered by creation time descending."""
